...
def load_image(image_path: str, image_size: int = 224) -> torch.Tensor:
    imagenet_mean = 0.37203550954887965
    imagenet_std = 0.21801310757916936
    transform = transforms.Compose(
        [
            CenterCrop(),
...
def get_parameter_depend_in_data_set(dataset: str) -> Dict[str, Any]:
    """
    Get parameters that depend on the dataset.
    """
    params = {}
    params["input_size"] = (224, 224) 
    params["mean"] = [0.37203550954887965]  
    params["std"] = [0.21801310757916936]
    params["classes"] = [0, 1]
